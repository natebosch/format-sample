              ...
              return TextField(
                ...
                decoration: InputDecoration(
                  disabledBorder: UnderlineInputBorder(
                    borderSide:
                        BorderSide(color: Color(0xFFD9EAF1).withOpacity(0.7)),
                  ),
                ...
                style: TextStyle(color: Color(0xFF274D85), fontSize: 22.0),
                autofocus: true,
            ...
            if (_filteredSongs.length == 0) {
              return Center(
                child: Text(
                  ...
                  style: TextStyle(fontSize: 22.0, color: Color(0xFF274D85)),
                ...
                return StreamBuilder<MapEntry<PlayerState, Song>>(
                  ...
                  builder: (
                    ...
                    return GestureDetector(
                      onTap: () {
                        _globalBloc.musicPlayerBloc.updatePlaylist(
                          _filteredSongs,
                        );
                        switch (_state) {
                      ...
                      child: SongTile(song: _filteredSongs[index]),
                    );
                  },
                );
              },
