...
class ResultScreen extends StatefulWidget {
  final int correct;
  const ResultScreen({Key key, this.correct}) : super(key: key);
  @override
...
class _ResultScreenState extends State<ResultScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String res = widget.correct == 10
        ? myStrings.loadWinLoose(true)
        : myStrings.loadWinLoose(false);
