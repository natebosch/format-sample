...
class DialogService {
    ...
    return showDialog(
      ...
      builder: (_) {
        return AlertDialog(
          ...
          actions: <Widget>[
            FlatButton(
              child: Text("OK", style: TextStyle(color: MyTheme.darkRed)),
              onPressed: () {
                Navigator.of(context, rootNavigator: true).pop(true);
              },
            ),
  ...
  static Future<dynamic> openImagePickingDialog(context, List<Album> albums) {
    ...
    BehaviorSubject<MediaCollection> selectedCollections =
        new BehaviorSubject<MediaCollection>();
        ...
        children: [
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.of(context, rootNavigator: true).pop(
                            Future.sync(() => File(urlList[index])),
                          );
                        },
                        child: FadeInImage(
                          ...
                          image: urlList[index] != null
                              ? FileImage(new File(urlList[index]))
                    ...
                    child: Container(
                      child: Center(
                        child: Text(
                          "Existent Albums",
                          style:
                              TextStyle(color: MyTheme.grey300, fontSize: 25),
                        ),
                      ),
                      height: height / 2,
                    ),
          ...
          Container(
            child: GestureDetector(
              ...
              child: StreamBuilder(
                stream: selectedCollections.asyncMap(
                  (event) => event.getMedias(mediaType: MediaType.image),
                ),
                builder: (context, AsyncSnapshot<dynamic> snapshot) {
                  if (!snapshot.hasData) {
                    return Center(
    ...
    return DialogService.showPersistentDialog(
      context,
      content: Content,
      title: "Pick a photo",
  ...
  static Future<dynamic> showPersistentDialog(
    context, {
    String message,
    Color titleColor,
    Color messageColor,
