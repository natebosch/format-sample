...
class RoadsterPage extends StatelessWidget {
                ...
                SliverBar(
                  ...
                  actions: <Widget>[
                    IconButton(
                      ...
                      onPressed: () => Share.share(FlutterI18n.translate(
                        context,
                    ...
                    PopupMenuButton<String>(
                      itemBuilder: (_) => Menu.wikipedia.map(
  ...
  Widget _roadsterCard(BuildContext context) {
    return CardPage(
      ...
      body: Column(
        children: <Widget>[
          RowItem.textRow(context, FlutterI18n.translate(
            context,
  ...
  Widget _orbitCard(BuildContext context) {
    return CardPage(
      title:
          FlutterI18n.translate(context, 'spacex.vehicle.roadster.orbit.title'),
      body: Column(
        children: <Widget>[
          RowItem.textRow(context, FlutterI18n.translate(
            context,
