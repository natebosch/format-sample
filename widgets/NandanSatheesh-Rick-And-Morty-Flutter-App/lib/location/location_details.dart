    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            SizedBox(height: 24),
            Center(child: Text(data.name, style: TextStyle(fontSize: 32))),
            SizedBox(height: 16),
            TableRowDetails(title: 'Type', value: data.type),
            TableRowDetails(title: 'Dimensions', value: data.dimension),
          ],
        ),
      ),
    );
