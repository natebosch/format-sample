...
ThemeData buildThemeData(BuildContext context, String theme) {
  ...
  newTextTheme = newTextTheme.copyWith(
    bodyText2:
        newTextTheme.bodyText2.copyWith(fontFamilyFallback: fontFamilyFallback),
    bodyText1:
        newTextTheme.bodyText1.copyWith(fontFamilyFallback: fontFamilyFallback),
    subtitle1:
        newTextTheme.subtitle1.copyWith(fontFamilyFallback: fontFamilyFallback),
    subtitle2:
        newTextTheme.subtitle2.copyWith(fontFamilyFallback: fontFamilyFallback),
    button:
        newTextTheme.button.copyWith(fontFamilyFallback: fontFamilyFallback),
  );
  return ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      enabledBorder: OutlineInputBorder(
        borderSide:
            BorderSide(color: dark ? Color(0xff585858) : SkyColors.grey4),
      ),
    ),
