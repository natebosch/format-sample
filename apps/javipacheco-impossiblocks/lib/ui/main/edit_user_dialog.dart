...
class EditUserDialog extends StatefulWidget {
  static show(
    ...
    Function(String, int) onChangeName, {
    String defaultName: "",
    int defaultAvatar: 0,
...
class _EditUserDialogState extends State<EditUserDialog> {
  ...
  void initState() {
    ...
    _pageController = PageController(
      ...
      initialPage: widget.defaultAvatar ?? 0,
    );
  ...
  dialogContent(BuildContext context) {
    return StoreConnector<AppState, CommonDialogViewModel>(
      ...
      builder: (context, viewModel) {
        double avatarRadiusDialog = Dimensions.avatarRadiusDialog(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ActionButtonDialog(
                      ...
                      text: ImpossiblocksLocalizations.of(context).text("ok"),
                      pressed: () {
