...
class _ReposHeaderItemState extends State<ReposHeaderItem> {
      ...
      child: new Container(
        ...
        child: new Text(
          ...
          style: GSYConstant.smallSubLightText.copyWith(
            shadows: [BoxShadow(color: Colors.grey, offset: Offset(0.5, 0.5))],
          ),
        ),
      ),
    );
  ...
  _renderTopicGroup(BuildContext context) {
    ...
    return new Container(
      ...
      child: Wrap(spacing: 10.0, runSpacing: 5.0, children: list),
    );
  }
    ...
    return new Row(
      children: <Widget>[
        ...
        new RawMaterialButton(
          ...
          child: new Text(
            widget.reposHeaderViewModel.ownerName!,
            style: GSYConstant.normalTextActionWhiteBold.copyWith(
              shadows: [
        ...
        new Text(
          ...
          style: GSYConstant.normalTextMitWhiteBold.copyWith(
            shadows: [BoxShadow(color: Colors.black, offset: Offset(0.5, 0.5))],
          ),
        ),
    ...
    new Future.delayed(Duration(seconds: 0), () {
      ...
      if (dy > 0 && headerSize != null && sizeTagContainer != null) {
        ...
        if (widgetHeight != newSize && newSize > 0) {
          ...
          widget.layoutListener?.call(
            Size(layoutKey.currentContext!.size!.width, widgetHeight),
          );
        }
      }
    });
            ...
            decoration: new BoxDecoration(
              image: new DecorationImage(
                ...
                image: new NetworkImage(
                  widget.reposHeaderViewModel.ownerPic ??
              ...
              child: new Padding(
                ...
                child: new Column(
                  ...
                  children: <Widget>[
                    ...
                    ///创建状态
                    renderRepoStatus(),
                    new Divider(color: GSYColors.subTextColor),
