...
class fileService {
  ...
  FutureOr<bool> isFileOnSDCard(File file) {
    ...
    String sdCardName = memoryCachingService.getCacheItem(
      CachedItems.SDCARD_NAME,
    );
  ...
  Future<bool> writeTags(Tune Song, {List<String> comments}) async {
    ...
    final blocks = writer.write(
      await ConversionUtils.FileUriTo8Bit(Song.uri),
      tag,
    );
