...
class ListPage extends StatefulWidget {
  const ListPage({required this.title, required this.typeFilter});
...
class _ListPageState extends State<ListPage> {
        ...
        actions: <Widget>[
          if (userProductListType != null)
            IconButton(
              ...
              onPressed: () async => _add(daoProductList, userProductListType),
            ),
        ],
      ),
  ...
  Future<void> _add(
    ...
    final ProductList? newProductList = await ProductListDialogHelper.instance
        .openNew(context, daoProductList, _list!, userProductListType);
