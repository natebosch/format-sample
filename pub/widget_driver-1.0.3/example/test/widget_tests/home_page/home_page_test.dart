...
void main() {
  group('HomePage:', () {
    ...
    setUp(() {
      ...
      when(() => mockHomePageDriver.title).thenReturn(
        'Hey this is a mocked title',
      );
    ...
    testWidgets('TabController has correct amount of tabs', (
      ...
      const mockOtherAppTabs = [AppTabType.community, AppTabType.consumption];

      when(() => mockHomePageDriver.numberOfTabs).thenReturn(
        mockAppTabs.length,
      );
    ...
    testWidgets(
      'TabController shows correct TabBarView when changing tab',
