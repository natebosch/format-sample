...
ARKitImageAnchor _$ARKitImageAnchorFromJson(Map json) => ARKitImageAnchor(
  ...
  const Vector2Converter().fromJson(json['referenceImagePhysicalSize'] as List),
...
Map<String, dynamic> _$ARKitImageAnchorToJson(ARKitImageAnchor instance) {
  ...
  val['referenceImagePhysicalSize'] = const Vector2Converter().toJson(
    instance.referenceImagePhysicalSize,
  );
...
Map<String, dynamic> _$ARKitFaceAnchorToJson(ARKitFaceAnchor instance) {
  ...
  val['leftEyeTransform'] = const MatrixConverter().toJson(
    instance.leftEyeTransform,
  );
  val['rightEyeTransform'] = const MatrixConverter().toJson(
    instance.rightEyeTransform,
  );
  val['geometryVertices'] = const Vector3ListConverter().toJson(
    instance.geometryVertices,
  );
