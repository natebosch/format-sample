...
class IndigitallFlutterPlugin {
  ...
  ///name of the plugin
  static const MethodChannel _indigitall = const MethodChannel(
  ...
  static void init(
    ...
    Function(ErrorModel error)? onErrorInitialized,
  ) async {
    print("[IND] init");
  ...
  static void deviceEnable(
    Function(Device device)? onSuccess,
  ...
  static void isIndigitallPushNotification(
    ...
    Function(bool isIndigitallPush) onSuccess,
  ) async {
    onSuccess(
      await _indigitall.invokeMethod(
        _ACTION_IS_INDIGITALL_PUSH_NOTIFICATION,
        remoteMessageData,
      ),
    );
  }
  ...
  static void onMessageReceived(
    Function(Map<dynamic, dynamic>? notification) onSuccess,
  ) async {
                  ...
                  if (key == _CALLBACK_GET_PUSH) {
                    if (onSuccess != null) {
                      if (valueMap is String) {
                        ...
                        onSuccess(
                          new Push(new Map<String, dynamic>.from(valueMap)),
                        );
                      }
                    }
                  }
  ...
  /// Throw [ErrorModel] if there is some error during the processs
  static void getInbox(
    Map? authInbox,
    Function(Inbox inbox)? onSuccess,
    Function(ErrorModel error)? onError,
  ) async {
    await _indigitall
  ...
  static void inAppGetHtml(
    String? url,
    Function(String html)? onSuccess,
  ) async {
    if (url != null) {
                ...
                value.forEach((key, valueMap) {
                  if (key == _CALLBACK_GET_INAPP) {
                    ...
                    if (newInApp.schema != null &&
                      ...
                      inAppGetHtml(
                        newInApp.properties?.contentUrl,
                        (html) async {
  ...
  static void showPopUp(
    ...
    Function(ErrorModel error)? onFail,
  ) async {
    _indigitall
  ...
  static void addNewInAppToDismissForever(InApp inApp) {
    _indigitall.invokeMapMethod(
      _ACTION_ADD_NEW_INAPP_TO_DISMISS_FOREVER,
      inApp.toMap(),
    );
  }
