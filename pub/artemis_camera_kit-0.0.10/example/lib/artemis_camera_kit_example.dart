...
class _MyAppState extends State<MyApp> {
  final ArtemisCameraKitController cameraKitController =
      ArtemisCameraKitController();
              ...
              Wrap(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      cameraKitController
                          .initCamera(hasBarcodeReader: true)
                          .then((value) {});
                    },
                  ...
                  TextButton(
                    onLongPress: () {
                      cameraKitController.getBarcodesFromImage(address).then(
                        (value) {
                          if (value == null) {
                            print("NULL Bar");
                          } else {
