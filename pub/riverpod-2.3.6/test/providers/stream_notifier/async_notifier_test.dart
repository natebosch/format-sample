...
void main() {
    ...
    group(factory.label, () {
      ...
      test(
        ...
        () async {
          ...
          expect(() => container.read(provider.notifier), throwsA(0));
      ...
      group('StreamNotifier.state', () {
        ...
        test('can be read inside build', () {
          ...
          final provider = factory.testProvider<int>(() {
            ...
            return notifier = factory.notifier<int>((ref) {
      ...
      group('StreamNotifierProvider.notifier', () {
        test(
          ...
          () async {
            ...
            final provider = factory.testProvider<int>(() {
              listener();
              return factory.notifier((ref) => Stream.value(ref.watch(dep)));
            });
            final container = createContainer();
  ...
  group('modifiers', () {
    ...
    void canBeAssignedToRefreshable<T>(Refreshable<T> provider) {}

    void canBeAssignedToAlwaysAliveListenable<T>(
      AlwaysAliveProviderListenable<T> provider,
    ) {}

    void canBeAssignedToProviderListenable<T>(ProviderListenable<T> provider) {}
