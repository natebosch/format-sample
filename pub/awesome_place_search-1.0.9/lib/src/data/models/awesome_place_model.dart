...
AwesomePlacesSearchModel awesomePlacesModelFromJson(
  String str,
...
class AwesomePlacesSearchModel extends AwesomePlacesSearchEntity {
  ...
  AwesomePlacesSearchModel({this.predictionsModel, String? status})
    : super(predictions: predictionsModel, status: status);

  factory AwesomePlacesSearchModel.fromJson(
...
class MatchedSubstring extends MatchedSubstringEntity {
  ...
  factory MatchedSubstring.fromJson(
    Map<String, dynamic> json,
...
class StructuredFormatting extends StructuredFormattingEntity {
  ...
  factory StructuredFormatting.fromJson(
    Map<String, dynamic> json,
  ) => StructuredFormatting(
    mainText: json["main_text"],
    mainTextMatchedSubstrings: json["main_text_matched_substrings"] == null
        ? []
        : List<MatchedSubstring>.from(json["main_text_matched_substrings"]!.map(
...
class Term extends TermEntity {
  Term({int? offset, String? value}) : super(offset: offset, value: value);
