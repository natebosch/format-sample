...
class _DigitsPadlockDialogState
    extends PadlockAlertDialogState<DigitsPadlockDialog> {
  ...
  void initState() {
    super.initState();
    Iterable<String> iterable = widget.shouldSeparateTextFields
        ? widget.padlock.digits.characters
        : [''];
