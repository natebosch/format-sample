...
NotificareNotification _$NotificareNotificationFromJson(
  ...
  content: (json['content'] as List<dynamic>).map(
    (e) => NotificareNotificationContent.fromJson(
      Map<String, dynamic>.from(e as Map),
    ),
  ).toList(),
  actions: (json['actions'] as List<dynamic>).map(
    (e) => NotificareNotificationAction.fromJson(
      Map<String, dynamic>.from(e as Map),
    ),
  ).toList(),
  attachments: (json['attachments'] as List<dynamic>).map(
    (e) => NotificareNotificationAttachment.fromJson(
      Map<String, dynamic>.from(e as Map),
    ),
  ).toList(),
...
NotificareNotificationAction _$NotificareNotificationActionFromJson(
  Map json,
