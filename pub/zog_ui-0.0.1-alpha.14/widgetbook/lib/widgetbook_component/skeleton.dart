                ...
                children: [
                  ZeroSkeletonAvatar(
                    style: SkeletonAvatarStyle(
                      ...
                      height: context.knobs.number(
                        label: 'SkeletonLAvatar Height',
                        initialValue: 30,
                      ).toDouble(),
                      width: context.knobs.number(
                        label: 'SkeletonAvatar Width',
                        initialValue: 30,
                      ).toDouble(),
                    ),
                  ),
                  ...
                  ZeroSkeletonLine(
                    style: SkeletonLineStyle(
                      ...
                      height: context.knobs.number(
                        label: 'SkeletonLine Height',
                        initialValue: 8,
                      ).toDouble(),
                      width: context.knobs.number(
                        label: 'SkeletonLine Width',
                        initialValue: 50,
                      ).toDouble(),
                    ),
                  ),
                  ...
                  ZeroSkeletonListTile(
                    hasLeading: context.knobs.boolean(
                      label: 'SkeletonListTile has heading',
                      initialValue: true,
                    ),
                    hasSubtitle: context.knobs.boolean(
                      label: 'SkeletonListTile has subtitle',
                      initialValue: true,
                    ),
                    contentSpacing: context.knobs.number(
                  ...
                  ZeroSkeletonParagraph(
                    style: SkeletonParagraphStyle(
                      lines: context.knobs.number(
                        label: 'SkeletonParagraph lines',
                        initialValue: 4,
                      ).toInt(),
                      spacing: context.knobs.number(
                        label: 'SkeletonParagraph spacing',
                        initialValue: 8,
                      ).toDouble(),
                    ),
                  ),
      ...
      builder: (context) => PreviewWidget(
            child: ZeroSkeletonListTile(
              ...
              subtitleStyle: SkeletonLineStyle(
                ...
                padding: const EdgeInsets.symmetric(horizontal: 8.0),
                randomLength: context.knobs.boolean(
                  label: 'Subtitle length is random',
                  initialValue: true,
                ),
                borderRadius: BorderRadius.circular(
                  context.knobs.number(
                    label: 'Subtitle border radius',
                    initialValue: 12,
                  ).toDouble(),
                ),
              ),
                ...
                child: SkeletonItem(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (context.knobs.boolean(
                        label: 'Has Description Paragraph',
                      ))
                        SizedBox(
                          width: 100,
                          child: ZeroSkeletonParagraph(
