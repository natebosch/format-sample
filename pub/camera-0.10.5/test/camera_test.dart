...
void main() {
  ...
  group('$CameraController', () {
    ...
    test('initialize() sets imageFormat', () async {
      ...
      await cameraController.initialize();
      verify(CameraPlatform.instance.initializeCamera(
        13,
        imageFormatGroup: ImageFormatGroup.yuv420,
      )).called(1);
    });
    ...
    test('setFlashMode() calls $CameraPlatform', () async {
      ...
      verify(CameraPlatform.instance.setFlashMode(
    ...
    test(
      ...
      () async {
        ...
        when(CameraPlatform.instance.setFlashMode(
          cameraController.cameraId,
          FlashMode.always,
    ...
    test('setExposureMode() calls $CameraPlatform', () async {
      ...
      verify(CameraPlatform.instance.setExposureMode(
        cameraController.cameraId,
        ExposureMode.auto,
      )).called(1);
    });
    ...
    test(
      ...
      () async {
        ...
        when(CameraPlatform.instance.setExposureMode(
          cameraController.cameraId,
          ExposureMode.auto,
        )).thenThrow(PlatformException(
          code: 'TEST_ERROR',
    ...
    test(
      ...
      () async {
        ...
        when(CameraPlatform.instance.getMinExposureOffset(
          cameraController.cameraId,
        )).thenThrow(
    ...
    test(
      ...
      () async {
        ...
        when(CameraPlatform.instance.getMaxExposureOffset(
          cameraController.cameraId,
        )).thenThrow(
          CameraException('TEST_ERROR', 'This is a test error message'),
        );
    ...
    test('getExposureOffsetStepSize() calls $CameraPlatform', () async {
      ...
      when(CameraPlatform.instance.getExposureOffsetStepSize(
        cameraController.cameraId,
      )).thenAnswer((_) => Future<double>.value(0.0));

      await cameraController.getExposureOffsetStepSize();

      verify(CameraPlatform.instance.getExposureOffsetStepSize(
        cameraController.cameraId,
      )).called(1);
    });
    ...
    test('setExposureOffset() calls $CameraPlatform', () async {
      ...
      when(CameraPlatform.instance.setExposureOffset(
        cameraController.cameraId,
        1.0,
      )).thenAnswer((_) async => 1.0);
      ...
      verify(CameraPlatform.instance.setExposureOffset(
        cameraController.cameraId,
        1.0,
      )).called(1);
    });
    ...
    test('unlockCaptureOrientation() calls $CameraPlatform', () async {
      ...
      verify(CameraPlatform.instance.unlockCaptureOrientation(
        cameraController.cameraId,
      )).called(1);
    });
    ...
    test(
      ...
      () async {
        ...
        await cameraController.initialize();
        when(CameraPlatform.instance.unlockCaptureOrientation(
          cameraController.cameraId,
        )).thenThrow(PlatformException(
          code: 'TEST_ERROR',
          message: 'This is a test error message',
