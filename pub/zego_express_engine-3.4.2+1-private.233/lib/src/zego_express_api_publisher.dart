...
extension ZegoExpressEnginePublisher on ZegoExpressEngine {
  ...
  Future<void> startPublishingStream(
    ...
    return await ZegoExpressImpl.instance.startPublishingStream(
      streamID,
      config: config,
      channel: channel,
    );
  ...
  Future<void> stopPublishingStream({ZegoPublishChannel? channel}) async {
    return await ZegoExpressImpl.instance.stopPublishingStream(
      channel: channel,
    );
  }
  ...
  Future<ZegoPublisherSetStreamExtraInfoResult> setStreamExtraInfo(
    ...
    return await ZegoExpressImpl.instance.setStreamExtraInfo(
      extraInfo,
      channel: channel,
    );
  }
  ...
  Future<void> startPreview({
    ...
    return await ZegoExpressImpl.instance.startPreview(
      canvas: canvas,
      channel: channel,
    );
  }
  ...
  Future<void> setVideoConfig(
    ...
    return await ZegoExpressImpl.instance.setVideoConfig(
      config,
      channel: channel,
    );
  }
  ...
  Future<void> setVideoMirrorMode(
    ...
    return await ZegoExpressImpl.instance.setVideoMirrorMode(
      mirrorMode,
      channel: channel,
    );
  }
  ...
  Future<void> setAppOrientation(
    ...
    return await ZegoExpressImpl.instance.setAppOrientation(
      orientation,
      channel: channel,
    );
  }
  ...
  Future<void> setAudioConfig(
    ...
    return await ZegoExpressImpl.instance.setAudioConfig(
      config,
      channel: channel,
    );
  }
  ...
  Future<void> setPublishStreamEncryptionKey(
    ...
    return await ZegoExpressImpl.instance.setPublishStreamEncryptionKey(
      key,
      channel: channel,
    );
  }
  ...
  Future<ZegoPublisherTakeSnapshotResult> takePublishStreamSnapshot({
    ...
    return await ZegoExpressImpl.instance.takePublishStreamSnapshot(
      channel: channel,
    );
  }
  ...
  Future<void> mutePublishStreamAudio(
    ...
    return await ZegoExpressImpl.instance.mutePublishStreamAudio(
      mute,
      channel: channel,
    );
  }
  ...
  Future<void> mutePublishStreamVideo(
    ...
    return await ZegoExpressImpl.instance.mutePublishStreamVideo(
      mute,
      channel: channel,
    );
  }
  ...
  Future<void> setStreamAlignmentProperty(
    ...
    return await ZegoExpressImpl.instance.setStreamAlignmentProperty(
      alignment,
      channel,
    );
  }
  ...
  Future<void> enableTrafficControl(bool enable, int property) async {
    return await ZegoExpressImpl.instance.enableTrafficControl(
      enable,
      property,
    );
  }
  ...
  Future<void> setMinVideoBitrateForTrafficControl(
    ...
    return await ZegoExpressImpl.instance.setMinVideoBitrateForTrafficControl(
      bitrate,
      mode,
      channel: channel,
    );
  ...
  Future<void> setMinVideoFpsForTrafficControl(
    ...
    return await ZegoExpressImpl.instance.setMinVideoFpsForTrafficControl(
      fps,
      channel: channel,
    );
  }
  ...
  Future<void> setTrafficControlFocusOn(
    ...
    return await ZegoExpressImpl.instance.setTrafficControlFocusOn(
      mode,
      channel: channel,
    );
  }
  ...
  Future<ZegoPublisherUpdateCdnUrlResult> removePublishCdnUrl(
    ...
    return await ZegoExpressImpl.instance.removePublishCdnUrl(
      streamID,
      targetURL,
    );
  }
  ...
  Future<void> enablePublishDirectToCDN(
    ...
    return await ZegoExpressImpl.instance.enablePublishDirectToCDN(
      enable,
      config: config,
      channel: channel,
    );
  ...
  Future<void> sendSEI(
    ...
    return await ZegoExpressImpl.instance.sendSEI(
      data,
      dataLength,
      channel: channel,
    );
  ...
  Future<void> sendAudioSideInfo(
    ...
    return await ZegoExpressImpl.instance.sendAudioSideInfo(
      data,
      timeStampMs,
      channel: channel,
    );
  ...
  Future<void> setDummyCaptureImagePath(
    ...
    return await ZegoExpressImpl.instance.setDummyCaptureImagePath(
      filePath,
      channel,
    );
  }
  ...
  Future<int> isVideoEncoderSupported(
    ...
    return await ZegoExpressImpl.instance.isVideoEncoderSupported(
      codecID,
  ...
  Future<void> setLowlightEnhancement(
    ...
    return await ZegoExpressImpl.instance.setLowlightEnhancement(
      mode,
      channel: channel,
    );
  }
  ...
  Future<int> setVideoSource(
    ...
    return await ZegoExpressImpl.instance.setVideoSource(
      source,
  ...
  Future<int> setAudioSource(
    ...
    return await ZegoExpressImpl.instance.setAudioSource(
      source,
      config: config,
      channel: channel,
    );
