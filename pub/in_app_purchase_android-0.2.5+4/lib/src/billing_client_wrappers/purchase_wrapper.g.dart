...
PurchaseHistoryRecordWrapper _$PurchaseHistoryRecordWrapperFromJson(
  Map json,
...
PurchasesResultWrapper _$PurchasesResultWrapperFromJson(
  Map json,
) => PurchasesResultWrapper(
  responseCode:
      const BillingResponseConverter().fromJson(json['responseCode'] as int?),
  billingResult: BillingResultWrapper.fromJson(
    (json['billingResult'] as Map?)?.map((k, e) => MapEntry(k as String, e)),
  ),
  purchasesList: (json['purchasesList'] as List<dynamic>?)?.map(
        (e) => PurchaseWrapper.fromJson(Map<String, dynamic>.from(e as Map)),
      ).toList() ??
      [],
);

PurchasesHistoryResult _$PurchasesHistoryResultFromJson(
  Map json,
  ...
  purchaseHistoryRecordList:
      (json['purchaseHistoryRecordList'] as List<dynamic>?)?.map(
            (e) => PurchaseHistoryRecordWrapper.fromJson(
